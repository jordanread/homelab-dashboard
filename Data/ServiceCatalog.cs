...
public sealed class ServiceCatalog : IServiceCatalog
{
    ...
    [
        ...
        new ServiceInfo //audiobookshelf
        {
            Slug = "audiobookshelf",
            Name = "Audiobookshelf",
            Icon = "🎧",
            Host = "audiobooks.flomads.com",
            LaunchUrl = "http://audiobooks.flomads.com",
            AccentToken = "gold",
            ...
            [
                ...
                new DetailSection
                {
                    ...
                    TipLabel = "📱 Mobile app:",
                    TipBody = "Install the free <strong>Audiobookshelf</strong> app (iOS/Android). In Settings, set the server URL to <code>http://abs.flomads.com</code> (on home Wi-Fi) or the Tailscale IP when away. Log in and your progress follows you everywhere."
                },
                new DetailSection
                {
        ...
        new ServiceInfo //calibre-web
        {
            Slug = "calibre",
            Name = "Calibre-Web",
            Icon = "📚",
            Host = "books.flomads.com",
            LaunchUrl = "http://books.flomads.com",
            AccentToken = "purple",
            Status = ServiceStatus.Running,
            ...
            [
                ...
                new DetailSection
                {
                    ...
                    BulletList =
                    [
                        "<strong>Browser</strong> — Open <a href=\"http://books.flomads.com\" target=\"_blank\">books.flomads.com</a> and use the built-in EPUB reader.",
                        ...
                        "<strong>OPDS</strong> — Compatible OPDS clients (Kybook, PocketBook) can subscribe to <code>books.flomads.com/opds</code>."
                    ]
                },
                new DetailSection
                {
